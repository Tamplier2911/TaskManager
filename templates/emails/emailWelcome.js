  ...
  return `
    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      <html>
        ...
        <body>
          <span class="preheader">Welcome! Thanks for trying out Task Manager.</span>
          <table
            class="email-wrapper"
            width="100%"
            cellpadding="0"
                ...
                >
                  <tr>
                    <td class="email-masthead">
                      <a
                        href="https://tasks-manager-s.herokuapp.com/"
                        ...
                        <tr>
                          <td class="content-cell">
                            <div class="f-fallback">
                              ...
                              <p>
                                Thanks for being a part of Task Manager. We're thrilled to
                                have you on board. You can start by viewing your
                                profile.
                              </p>
                              <!-- Action -->
                              <table
                 ...
                 https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                              ...
                              <table class="body-sub" role="presentation">
                                <tr>
                                  <td>
                                    <p class="f-fallback sub">
                                      If you’re havent registred on www.herokuapp.task-manager-s.com
                        ...
                        <tr>
                          <td class="content-cell" align="center">
                            <p class="f-fallback sub align-center">
                              &copy; 2020 Task Manager. All rights reserved.
                            </p>
                            <p class="f-fallback sub align-center">
                              Task Manager
